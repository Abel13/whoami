...
import FamousWorldwide from "@/data/famosos-mundiais.json";
import Movies from "@/data/filmes.json";
import Flowers from "@/data/flores.json";
import Fruits from "@/data/frutas.json";
import HarryPotter from "@/data/harry-potter.json";
...
import Pokemons from "@/data/pokémons.json";
