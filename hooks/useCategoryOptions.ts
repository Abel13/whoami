...
export const categories = {
  ...
  "🎵 Clássicos da Música Brasileira": [
    ...
    "Boate Azul - Milionário & José Rico",
    "Saudade da Minha Terra - Sérgio Reis",
    "Caminheiro - Almir Sater",
    ...
    "Vem Meu Amor - Banda Cheiro de Amor",
    "Levada Louca - Banda Cheiro de Amor",
    "Bate Lata - Timbalada",
    "Araketu é Bom Demais - Araketu",
    "Prefixo de Verão - Banda Mel",
    "Tantinho - Chiclete com Banana",
  ],
  "🎥 Filmes": [
    "A Origem",
    "Titanic",
...
export function useCategoryOptions(category: CategoryKey) {
  const [options, setOptions] = useState([...categories[category]]);
